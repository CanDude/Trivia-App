// get element by ID m # nae lagaty q k wo already ID he pick krta h lk us k illawa koi bhi method use kryngy js ka to us m # laga k define krna hoga ID ko
...
function addGenre(genre) {
    ...
    // append js ka method h. ye kya kr rha h game k div m is coloumn ko add kr rha h
    game.append(column)
...
allCards.forEach(card => card.addEventListener('click', flipCard))
    ...
    if (cardOfButton.getAttribute('data-answer') === this.innerHTML){
       ...
       setTimeout(()=>{
        ...
        setTimeout(()=>{
            while (cardOfButton.secondChild){
